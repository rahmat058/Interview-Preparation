...
import { clearSelection, setEntityTypeFilter, setQuery } from '@/lib/store/slices/searchSlice'
...
export function SearchApp() {
  ...
  const { selectedItem, entityTypeFilter } = useAppSelector((state) => state.search)
  ...
  return (
    <main className="mx-auto max-w-4xl flex-1 px-4 py-10 sm:px-6">
      <motion.div
        ...
        <h2 className="bg-gradient-to-r from-indigo-600 via-violet-600 to-cyan-500 bg-clip-text text-3xl font-bold text-transparent sm:text-4xl">
          Autocomplete Search
        </h2>
